            ...
            <div class="row">
                ...
                <div class="col-md-12 mt-2">
                    ...
                    @if($sosmed->image_path)
                        <small class="form-text text-muted">Icon saat ini:</small>
                        <img id="imagePreviewEditExisting" src="{{ asset('storage/' . $sosmed->image_path) }}" alt="Icon" class="img-thumbnail mt-2" style="max-height: 150px;">
                    @endif

                    {{-- Preview icon baru --}}
                    <img id="imagePreviewEdit" src="#" alt="Preview Baru" class="mt-2 d-none img-thumbnail" style="max-height: 150px;">
                </div>
            </div>
