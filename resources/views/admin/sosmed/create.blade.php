    ...
    <x-adminlte-card title="Form Tambah Sosial Media" theme="lightblue" theme-mode="outline">
        <form action="{{ route('admin.sosmed.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <x-adminlte-input name="url" label="URL" placeholder="Contoh: https://instagram.com/akunmu" required/>
                </div>

                <div class="col-md-12 mt-2">
                    <x-adminlte-input-file name="image_path" label="Icon / Logo (opsional)" igroup-size="md" id="imageInputCreate" />
                    <small id="fileNameCreate" class="form-text text-muted mt-1"></small>
                    <img id="imagePreviewCreate" src="#" alt="Preview" class="mt-2 d-none img-thumbnail" style="max-height: 150px;">
                </div>
            </div>
